const Process = () => {
  const steps = [
    ...
    },
    {
      ...
      description: "Using 3d printers, we manufacture each component with precision and care, ensuring perfect fit and functionality."
    },
    {
      number: "03",
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-2 gap-6">
                    ...
                    <div className="text-center p-4 bg-warm-accent/5 rounded-xl">
                      <div className="text-3xl font-bold text-warm-accent mb-1">xhrs</div>
                      <div className="text-sm text-muted-foreground">Spent in Production</div>
                    </div>
                    <div className="text-center p-4 bg-accent/5 rounded-xl">
                      <div className="text-3xl font-bold text-accent mb-1">$x</div>
                      <div className="text-sm text-muted-foreground">Dollars Raised</div>
                    </div>
                    <div className="text-center p-4 bg-primary/5 rounded-xl">
                      <div className="text-3xl font-bold text-primary mb-1">x</div>
