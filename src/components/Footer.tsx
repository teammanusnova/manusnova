const Footer = () => {
  ...
  return (
    <footer className="bg-zinc-950 pt-16 sm:pt-20 pb-10">
      <div className="max-w-7xl mx-auto px-6">

        {/* Giant wordmark */}
        <div className="border-b border-white/[0.06] pb-12 mb-10 overflow-hidden">
          <p className="text-[13vw] font-black text-white/[0.04] leading-none tracking-tighter select-none whitespace-nowrap">
            MANUS NOVA
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-3 gap-10 mb-14">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2.5 text-sm text-zinc-500">
              <a href="mailto:teammanusnova@gmail.com" className="block hover:text-white transition-colors break-all">
                teammanusnova@gmail.com
              </a>
              <p>75 W 205th St<br />Bronx, NY 10468</p>
            </div>
          </div>
        </div>
