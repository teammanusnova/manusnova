          ...
          <div className="grid md:grid-cols-2 gap-8 mb-16">
            ...
            <Card className="p-8 bg-card border-border shadow-lg">
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground">
                  Every prosthetic we create represents more than engineering—it's about restoring 
                  independence, confidence, and possibility to individuals in our community.
                </p>
              </div>
            </Card>
          </div>
          ...
          <div className="bg-primary/5 rounded-2xl p-8 border border-primary/10">
            <blockquote className="text-center">
              <p className="text-lg italic text-foreground mb-4">
                "These students aren't just learning about engineering—they're living it, 
                breathing it, and using it to change lives. The dedication and innovation 
                I've witnessed is truly remarkable."
              </p>
              <footer className="text-muted-foreground">
                — Dr. Sarah Chen, Faculty Advisor
              </footer>
            </blockquote>
          </div>
        </div>
